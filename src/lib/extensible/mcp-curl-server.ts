...
export class McpCurlServer {
     ...
     */
    getRegisteredCustomTools(): ReadonlyArray<{ readonly name: string; readonly meta: Readonly<CustomToolMeta> }> {
        return this._customTools.map(({ name, meta }) =>
            Object.freeze({
                name,
                meta: Object.freeze({
                    title: meta.title,
                    ...
                    annotations: meta.annotations
                        ? Object.freeze({ ...meta.annotations })
                        : undefined,
                }),
            })
        );
