import type { McpCurlConfig, BeforeRequestHook, AfterResponseHook, OnErrorHook, CurlExecuteInput, JqQueryInput } from "../types/public.js";
/**
 ...
 */
export type CurlToolExecutor = (params: CurlExecuteInput, extra: ToolExtra) => Promise<ToolResult>;
/**
 * Tool executor function signature for jq_query.
 */
export type JqToolExecutor = (params: JqQueryInput, extra: ToolExtra) => Promise<ToolResult>;
/**
 ...
 */
export type ToolInput<T extends ToolName> = T extends "curl_execute" ? CurlExecuteInput : T extends "jq_query" ? JqQueryInput : never;
