 ...
 */
export async function executeJqQuery(params, _extra) {
    try {
 ...
 */
export function registerJqQueryTool(server) {
    server.registerTool("jq_query", JQ_QUERY_TOOL_META, async (params, extra) => executeJqQuery(params, extra));
}
